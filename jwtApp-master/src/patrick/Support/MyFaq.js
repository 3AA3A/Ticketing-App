...
export default function MyFaq({ faq, remove }) {
  ...
  return (
    ...
    //   <td>{faq.answer}</td>
    //   <td>
    //   <Button size="sm" variant="light" as={Link} to={`/editfaq/${faq.id}`}>Edit</Button>
    //   <Button variant="danger" size="sm" onClick={() => remove(faq.id)}>X</Button>
    //   </td>
    // </tr>
  )
}
